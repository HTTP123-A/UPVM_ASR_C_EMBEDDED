#ifndef _WEIGHT_LOADING_F32_I8_
#define _WEIGHT_LOADING_F32_I8_
...
#define WEIGHT_MEMBER_BUF_SIZE  128U
 ...
 * Per spec, fills one struct qconv_int8 from:
 *   <m>_w.bin (int8), <m>_w_quant_scale.bin (f32, act_scale_len),
 *   <m>_w_dequant_scale.bin (f32, c_out), <m>_b_i32.bin (int32, c_out, only when has_bias) */
...
#endif /* __WEIGHT_LOADING_F32_I8__ */
