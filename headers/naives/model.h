...
#define ACT_BUF_ELEMENT             ((4U * (R_OUT_3 + 2U * N_OUT_3) + 9U * D_INNER_OUT_3) * L_OUT_3) // OUTPUT 3 is largest
#define LOW_FREQ_ELEMENT            (LOW_FREQ_HF * W_IN_PATCH_EMBED)
    /*< 2. Residual buffers >*/
#define INTERNAL_RES_BUF_ELEMENT    (C_OUT_1 * L_OUT_1)
#define GLOBAL_RES_BUF_ELEMENT      ((C_IN_PATCH_EMBED * H_IN_PATCH_EMBED * W_IN_PATCH_EMBED) +\
    ...
    /*< 3. Hidden buffers >*/
#define HIDDEN_STATE_BUF_ELEMENT    (4U * SUB_D_INNER_DEC_0 * N_DEC_0) // DECODER 0 is the largest
...
/*< 4. Full dual-stream UPVM-ASR with detail timing profile >*/
