/* Timing variant of vss_output0_mp_f32i8 (sq_int8_v0, DETAIL profile).
 * Identical mixed-precision compute to model/vss_output0_mp_f32i8.c (ss2d f32,
 * mlp fc1/fc2 + pe int8; no block norms, input offset); adds pvss_time
 * (SSM->MLP boundary) and mlp_time (function end, after PatchExpanding norm). */

#include "macro_kernels.h"
/*< 11. VSS Output0 - timing variant >*/
