/* Timing variant of vss_output1_mp_f32i8 (sq_int8_v0, DETAIL profile).
 * Identical mixed-precision compute to model/vss_output1_mp_f32i8.c (ss2d f32,
 * mlp fc1/fc2 + pe int8; block norms present, input read from base); adds
 * pvss_time (SSM->MLP boundary) and mlp_time (function end, after PE norm). */

#include "macro_kernels.h"
/*< 12. VSS Output1 - timing variant >*/
