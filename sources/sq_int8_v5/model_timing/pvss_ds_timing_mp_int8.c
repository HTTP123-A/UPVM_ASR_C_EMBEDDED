...
#pragma omp parallel num_threads((int)mp_parallel_factor)
{
    ...
    /*< MLP input projection (int8): [C,H,W] -> [MLP_HIDDEN_DIM,H,W] : quant -> conv -> dequant >*/
    {
        ...
        requant_int32_to_int8_perchannel(acc_buf, quant_buf, MLP_HIDDEN_DIM, L2, pvss_ds_weight->mlp_requant_scale); /* v4: fused fc1 dequant + fc2 quant -> int8 (requant=deq/act_next), straight into quant_buf */
    }
