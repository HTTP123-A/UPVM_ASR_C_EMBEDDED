/* Split from sources/sq_int8_v0/model.c — DETAIL_STAGE_TIMING orchestrator.
 * Same mixed-precision (f32 + int8) forward as model/model.c; in addition to the
 * per-stage clock_gettime samples it calls the *timing* block variants, which
 * also report the PVSS-vs-MLP split (pvss_time / mlp_time) per block. */
...
#pragma omp single
{
    ...
    if (tid == 0) {
        /*< Mag >*/
        pvss_ds_timing_mp_int8(model_inout_buf_mag + (size_t)W_IN_PATCH_EMBED,
        ...
        /*< Pha >*/
        pvss_ds_timing_mp_int8(model_inout_buf_pha + (size_t)W_IN_PATCH_EMBED,
...
#pragma omp single
{
    ...
    if (tid == 0) {
        /*< Mag >*/
        pvss_latent_timing_mp_int8(model_inout_buf_mag + (size_t)W_IN_PATCH_EMBED,
                        model_internal_res_buf_mag,
                        model_act_buf_mag,
                        hidden_state_buf_mag,
                        quant_buf_mag, acc_buf_mag,
        ...
        /*< Pha >*/
        pvss_latent_timing_mp_int8(model_inout_buf_pha + (size_t)W_IN_PATCH_EMBED,
                        model_internal_res_buf_pha,
                        model_act_buf_pha,
                        hidden_state_buf_pha,
                        quant_buf_pha, acc_buf_pha,
...
#pragma omp single
{
    ...
    if (tid == 0) {
        ...
        /*< Mag >*/
        pvss_us_timing_mp_int8(model_inout_buf_mag + (size_t)W_IN_PATCH_EMBED,
                    model_internal_res_buf_mag,
                    model_act_buf_mag,
                    hidden_state_buf_mag,
                    quant_buf_mag, acc_buf_mag,
        ...
        /*< Pha >*/
        pvss_us_timing_mp_int8(model_inout_buf_pha + (size_t)W_IN_PATCH_EMBED,
                    model_internal_res_buf_pha,
                    model_act_buf_pha,
                    hidden_state_buf_pha,
                    quant_buf_pha, acc_buf_pha,
...
#pragma omp single
{
    ...
    if (tid == 0) {
        ...
        /*< Mag >*/
        vss_output0_timing_mp_f32i8(model_inout_buf_mag + (size_t)W_IN_PATCH_EMBED,
                    model_internal_res_buf_mag,
                    model_act_buf_mag,
                    hidden_state_buf_mag,
                    quant_buf_mag, acc_buf_mag,
        ...
        /*< Pha >*/
        vss_output0_timing_mp_f32i8(model_inout_buf_pha + (size_t)W_IN_PATCH_EMBED,
                    model_internal_res_buf_pha,
                    model_act_buf_pha,
                    hidden_state_buf_pha,
                    quant_buf_pha, acc_buf_pha,
    ...
    if (tid == 0) {
        /*< Mag >*/
        vss_output1_timing_mp_f32i8(model_inout_buf_mag + (size_t)W_IN_PATCH_EMBED,
                    model_internal_res_buf_mag,
                    model_act_buf_mag,
                    hidden_state_buf_mag,
                    quant_buf_mag, acc_buf_mag,
        ...
        /*< Pha >*/
        vss_output1_timing_mp_f32i8(model_inout_buf_pha + (size_t)W_IN_PATCH_EMBED,
                    model_internal_res_buf_pha,
                    model_act_buf_pha,
                    hidden_state_buf_pha,
                    quant_buf_pha, acc_buf_pha,
    ...
    if (tid == 0) {
        /*< Mag >*/
        vss_output3_timing_f32i8(model_inout_buf_mag + (size_t)W_IN_PATCH_EMBED,
                        model_internal_res_buf_mag,
                        model_act_buf_mag,
                        hidden_state_buf_mag,
                        quant_buf_mag, acc_buf_mag,
        ...
        /*< Pha >*/
        vss_output3_timing_f32i8(model_inout_buf_pha + (size_t)W_IN_PATCH_EMBED,
                        model_internal_res_buf_pha,
                        model_act_buf_pha,
                        hidden_state_buf_pha,
                        quant_buf_pha, acc_buf_pha,
