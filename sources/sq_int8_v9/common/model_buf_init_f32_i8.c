...
#include "model.h"
/*< 1. Weight & Other buffers init (INT8-F32 mixed precision weights, f32 work buffers) >*/
                        ...
                        int32_t **acc_buf_mag, int32_t **acc_buf_pha)
{
    ...
    *quant_buf_mag = calloc((size_t)QUANT_BUF_ELEMENT, sizeof(int8_t));
    *quant_buf_pha = calloc((size_t)QUANT_BUF_ELEMENT, sizeof(int8_t));
    *acc_buf_mag   = calloc((size_t)ACC_BUF_ELEMENT,   sizeof(int32_t));
    *acc_buf_pha   = calloc((size_t)ACC_BUF_ELEMENT,   sizeof(int32_t));
    ...
    *model_weight = (struct upvm_asr_weight *)calloc(1U, sizeof(**model_weight));
    ...
    load_pvss_us_weight_stage(&(*model_weight)->pvss_us_weight_dec0_mag,
                              ...
                              C_DEC_0, R_DEC_0, N_DEC_0, R2N_DEC_0, DW_KERNEL_SZ_DEC_0,
    ...
    load_pvss_us_weight_stage(&(*model_weight)->pvss_us_weight_dec1_mag,
                              ...
                              C_DEC_1, R_DEC_1, N_DEC_1, R2N_DEC_1, DW_KERNEL_SZ_DEC_1,
    ...
    load_pvss_us_weight_stage(&(*model_weight)->pvss_us_weight_dec2_mag,
                              ...
                              C_DEC_2, R_DEC_2, N_DEC_2, R2N_DEC_2, DW_KERNEL_SZ_DEC_2,
    ...
    load_vss_output0_weight_stage(&(*model_weight)->vss_output0_weight_mag,
                                  weight_path,
                                  "vss_output0_weight_mag",
                                  C_OUT_0, R_OUT_0, N_OUT_0, R2N_OUT_0, DW_KERNEL_SZ_OUT_0,
                                  MLP_HIDDEN_OUT_0, SUB_D_INNER_OUT_0, SUB_D_PROJECTION_OUT_0, SUB_C_OUT_0);
    load_vss_output0_weight_stage(&(*model_weight)->vss_output0_weight_pha,
                                  weight_path,
                                  "vss_output0_weight_pha",
                                  C_OUT_0, R_OUT_0, N_OUT_0, R2N_OUT_0, DW_KERNEL_SZ_OUT_0,
                                  MLP_HIDDEN_OUT_0, SUB_D_INNER_OUT_0, SUB_D_PROJECTION_OUT_0, SUB_C_OUT_0);

    load_vss_output1_weight_stage(&(*model_weight)->vss_output1_weight_mag,
                                  weight_path,
                                  "vss_output1_weight_mag",
                                  C_OUT_1, R_OUT_1, N_OUT_1, R2N_OUT_1, DW_KERNEL_SZ_OUT_1,
                                  MLP_HIDDEN_OUT_1, SUB_D_INNER_OUT_1, SUB_D_PROJECTION_OUT_1, SUB_C_OUT_1);
    load_vss_output1_weight_stage(&(*model_weight)->vss_output1_weight_pha,
                                  weight_path,
                                  "vss_output1_weight_pha",
                                  C_OUT_1, R_OUT_1, N_OUT_1, R2N_OUT_1, DW_KERNEL_SZ_OUT_1,
                                  MLP_HIDDEN_OUT_1, SUB_D_INNER_OUT_1, SUB_D_PROJECTION_OUT_1, SUB_C_OUT_1);

    load_vss_output3_weight_stage(&(*model_weight)->vss_output3_weight_mag,
                                  weight_path,
    ...
    load_vss_output3_weight_stage(&(*model_weight)->vss_output3_weight_pha,
                                  weight_path,
