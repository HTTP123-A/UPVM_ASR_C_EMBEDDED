...
#include "model.h" 
void dual_stream_unet_detail_timing_profiling_f32(float* audio, // [L_AUDIO]
    /* ----- weights ----------------------------------------- */
                        ...
                        struct detail_timing_record_points *detail_timing_record)
{
    ...
    /*< --- Encoder 0 --- >*/
        /*< Mag >*/
    pvss_ds_timing_f32(model_inout_buf_mag + (size_t)W_IN_PATCH_EMBED,
    ...
    clock_gettime(CLOCK_MONOTONIC, &(detail_timing_record->encoder0_mag_time));
        ...
        /*< Pha >*/
    pvss_ds_timing_f32(model_inout_buf_pha + (size_t)W_IN_PATCH_EMBED,
    ...
    /*< --- Latent ------ >*/
        /*< Mag >*/
    pvss_latent_timing_f32(model_inout_buf_mag + (size_t)W_IN_PATCH_EMBED,
                    model_internal_res_buf_mag,
                    model_act_buf_mag,
                    hidden_state_buf_mag,
    ...
    clock_gettime(CLOCK_MONOTONIC, &(detail_timing_record->latent_mag_time));
        ...
        /*< Pha >*/
    pvss_latent_timing_f32(model_inout_buf_pha + (size_t)W_IN_PATCH_EMBED,
                    model_internal_res_buf_pha,
                    model_act_buf_pha,
                    hidden_state_buf_pha,
    ...
    clock_gettime(CLOCK_MONOTONIC, &(detail_timing_record->decoder0_res_pha_time));
        ...
        /*< Mag >*/
    pvss_us_timing_f32(model_inout_buf_mag + (size_t)W_IN_PATCH_EMBED,
                model_internal_res_buf_mag,
                model_act_buf_mag,
                hidden_state_buf_mag,
    ...
    clock_gettime(CLOCK_MONOTONIC, &(detail_timing_record->decoder0_mag_time));
        ...
        /*< Pha >*/
    pvss_us_timing_f32(model_inout_buf_pha + (size_t)W_IN_PATCH_EMBED,
                model_internal_res_buf_pha,
                model_act_buf_pha,
                hidden_state_buf_pha,
