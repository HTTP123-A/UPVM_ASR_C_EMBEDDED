...
#pragma omp parallel num_threads((int)mp_parallel_factor)
{
    ...
    /*< MLP input projection (int8): [C,H,W] -> [MLP_HIDDEN_DIM,H,W] : quant -> conv -> dequant >*/
    {
        ...
        dequant_int32_to_f32_perchannel(acc_buf, pvss_act_buf, MLP_HIDDEN_DIM, L2, q->deq_scale);
    }
    ...
    /*< MLP output projection (int8): [MLP_HIDDEN_DIM,H/2,W/2] -> [2C,H/2,W/2] : quant -> conv -> dequant >*/
    {
        const struct qconv_int8 *q = &pvss_ds_weight->mlp_fc2;
        quant_f32_to_int8_perchannel(pvss_act_buf, quant_buf, MLP_HIDDEN_DIM, L2, q->act_scale, 0);
