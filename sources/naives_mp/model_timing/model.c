...
#include "model.h"
/*< 3. Full dual-stream UPVM-ASR with timing profile >*/
void dual_stream_unet_timing_profiling_mp_f32(float* audio, // [L_AUDIO]
    /* ----- weights ----------------------------------------- */
...
#pragma omp single
{
    ...
    if (tid == 0) {
        /*< Mag >*/
        pvss_ds_mp_f32(model_inout_buf_mag + (size_t)W_IN_PATCH_EMBED,
        ...
        /*< Pha >*/
        pvss_ds_mp_f32(model_inout_buf_pha + (size_t)W_IN_PATCH_EMBED,
...
#pragma omp single
{
    ...
    if (tid == 0) {
        /*< Mag >*/
        pvss_latent_mp_f32(model_inout_buf_mag + (size_t)W_IN_PATCH_EMBED,
                        model_internal_res_buf_mag,
                        model_act_buf_mag,
                        hidden_state_buf_mag,
                ...
                /* --- [28] Get latent pvss time ---*/
        clock_gettime(CLOCK_MONOTONIC, &(timing_record->latent_mag_time));

    }
    else {
        /*< Pha >*/
        pvss_latent_mp_f32(model_inout_buf_pha + (size_t)W_IN_PATCH_EMBED,
                        model_internal_res_buf_pha,
                        model_act_buf_pha,
                        hidden_state_buf_pha,
...
#pragma omp single
{
    ...
    if (tid == 0) {
        ...
        /*< Mag >*/
        pvss_us_mp_f32(model_inout_buf_mag + (size_t)W_IN_PATCH_EMBED,
                    model_internal_res_buf_mag,
                    model_act_buf_mag,
                    hidden_state_buf_mag,
        ...
        /*< Pha >*/
        pvss_us_mp_f32(model_inout_buf_pha + (size_t)W_IN_PATCH_EMBED,
                    model_internal_res_buf_pha,
                    model_act_buf_pha,
                    hidden_state_buf_pha,
