                          ...
                          uint32_t R2N, uint32_t red, uint32_t dwk)
{
    ...
    mem_profile_log(stage, "in_proj.requant_x", "INT8-ACCEL", red, "int32", (uint64_t)D * Ll,     (uint64_t)D * 4U, "int8",  (uint64_t)D * Ll); /* v5: x branch fused deq+quant, requant_scale[D] */
