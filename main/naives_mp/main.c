...
int main(int argc, char *argv[])
{
    ...
    FILE *csv_fp, *stage_timing_csv_fp, *detail_stage_timing_csv_fp;
    ...
    while ((entry = readdir(dir_ptr)) != NULL) {
        ...
        for (seg_idx = 0U; seg_idx < meta.num_segments; ++seg_idx) {
...
#ifdef _MODEL_STAGE_TIMING_
            dual_stream_unet_timing_profiling_mp_f32(
                audio,
                model_weight,
                model_inout_buf_mag, model_inout_buf_pha,
                model_internal_res_buf_mag, model_internal_res_buf_pha,
            ...
            dual_stream_unet_detail_timing_profiling_mp_f32(
                audio,
                model_weight,
                model_inout_buf_mag, model_inout_buf_pha,
                model_internal_res_buf_mag, model_internal_res_buf_pha,
