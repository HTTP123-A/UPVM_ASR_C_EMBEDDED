...
/* ===================== DEFINE ============================== */
/*< 1. Paths >*/
#define WEIGHT_PATH                     "./data/weight_sq_int8_v0/"
#define DEGRADED_AUDIO_PATH             "./data/test_audio/downsample/"
#define GENERATED_AUDIO_PATH            "./data/test_audio/generated/sq_int8_v0/"

#define RESULT_PATH                     "./results/sq_int8_v0/"
#define PROCESSING_TIMING_CSV_PATH      "./results/sq_int8_v0/processing_time.csv"
#define PROCESSING_TIMING_TXT_PATH      "./results/sq_int8_v0/processing_time.txt"
#define STAGE_TIMING_CSV_PATH           "./results/sq_int8_v0/stage_timing.csv"
#define DETAIL_STAGE_TIMING_CSV_PATH    "./results/sq_int8_v0/detail_stage_timing.csv"
#define MEM_PROFILE_CSV_PATH            "./results/sq_int8_v0/memory_profile.csv"
