...
/* ===================== DEFINE ============================== */
/*< 1. Paths >*/
/* v2 uses its own W8A8 weight copy (data/weight_sq_int8_v2/, copied from v0); the
 * int32 ReLU + SumPool fusion changes no weights or scales. */
#define WEIGHT_PATH                     "./data/weight_sq_int8_v2/"
#define DEGRADED_AUDIO_PATH             "./data/test_audio/downsample/"
#define GENERATED_AUDIO_PATH            "./data/test_audio/generated/sq_int8_v2/"

#define RESULT_PATH                     "./results/sq_int8_v2/"
#define PROCESSING_TIMING_CSV_PATH      "./results/sq_int8_v2/processing_time.csv"
#define PROCESSING_TIMING_TXT_PATH      "./results/sq_int8_v2/processing_time.txt"
#define STAGE_TIMING_CSV_PATH           "./results/sq_int8_v2/stage_timing.csv"
#define DETAIL_STAGE_TIMING_CSV_PATH    "./results/sq_int8_v2/detail_stage_timing.csv"
#define MEM_PROFILE_CSV_PATH            "./results/sq_int8_v2/memory_profile.csv"
