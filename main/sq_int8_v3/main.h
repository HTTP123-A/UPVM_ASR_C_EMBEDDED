...
/* ===================== DEFINE ============================== */
/*< 1. Paths >*/
/* v3 uses its own W8A8 weight copy (data/weight_sq_int8_v3/, copied from v2); the
 * int32 ReLU + SumPool + SSM-x-ReLU fusions change no weights or scales. */
#define WEIGHT_PATH                     "./data/weight_sq_int8_v3/"
#define DEGRADED_AUDIO_PATH             "./data/test_audio/downsample/"
#define GENERATED_AUDIO_PATH            "./data/test_audio/generated/sq_int8_v3/"

#define RESULT_PATH                     "./results/sq_int8_v3/"
#define PROCESSING_TIMING_CSV_PATH      "./results/sq_int8_v3/processing_time.csv"
#define PROCESSING_TIMING_TXT_PATH      "./results/sq_int8_v3/processing_time.txt"
#define STAGE_TIMING_CSV_PATH           "./results/sq_int8_v3/stage_timing.csv"
#define DETAIL_STAGE_TIMING_CSV_PATH    "./results/sq_int8_v3/detail_stage_timing.csv"
#define MEM_PROFILE_CSV_PATH            "./results/sq_int8_v3/memory_profile.csv"
