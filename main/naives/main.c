...
int main(int argc, char *argv[])
{
    ...
    while ((entry = readdir(dir_ptr)) != NULL) {
        ...
        for (seg_idx = 0U; seg_idx < meta.num_segments; ++seg_idx) {
...
#ifdef _MODEL_STAGE_TIMING_
            dual_stream_unet_timing_profiling_f32(
                audio,
                model_weight,
                model_inout_buf_mag, model_inout_buf_pha,
                model_internal_res_buf_mag, model_internal_res_buf_pha,
            ...
            dual_stream_unet_detail_timing_profiling_f32(
                audio,
                model_weight,
                model_inout_buf_mag, model_inout_buf_pha,
                model_internal_res_buf_mag, model_internal_res_buf_pha,
            ...
            low_freq_pha_time = elapsed_ms(&stage_timing_record.low_frequency_mag_time, &stage_timing_record.low_frequency_pha_time);

            spectrogram_res_mag_time = elapsed_ms(&stage_timing_record.low_frequency_pha_time, &stage_timing_record.spectrogram_res_mag_time);            
            /* --------------------- */
            patch_embed_mag_time = elapsed_ms(&stage_timing_record.spectrogram_res_mag_time, &stage_timing_record.patch_embed_mag_time);
            patch_embed_pha_time = elapsed_ms(&stage_timing_record.patch_embed_mag_time, &stage_timing_record.patch_embed_pha_time);
            
            patch_embed_res_mag_time = elapsed_ms(&stage_timing_record.patch_embed_pha_time, &stage_timing_record.patch_embed_res_mag_time);
            patch_embed_res_pha_time = elapsed_ms(&stage_timing_record.patch_embed_res_mag_time, &stage_timing_record.patch_embed_res_pha_time);

            patch_embed_interaction_mag_time = elapsed_ms(&stage_timing_record.patch_embed_res_pha_time, &stage_timing_record.patch_embed_interaction_mag_time);
            ...
            encoder0_pha_time = elapsed_ms(&stage_timing_record.encoder0_mag_time, &stage_timing_record.encoder0_pha_time);

            encoder0_res_mag_time = elapsed_ms(&stage_timing_record.encoder0_pha_time, &stage_timing_record.encoder0_res_mag_time);
            encoder0_res_pha_time = elapsed_ms(&stage_timing_record.encoder0_res_mag_time, &stage_timing_record.encoder0_res_pha_time);

            encoder0_interaction_mag_time = elapsed_ms(&stage_timing_record.encoder0_res_pha_time, &stage_timing_record.encoder0_interaction_mag_time);
            ...
            encoder1_pha_time = elapsed_ms(&stage_timing_record.encoder1_mag_time, &stage_timing_record.encoder1_pha_time);

            encoder1_res_mag_time = elapsed_ms(&stage_timing_record.encoder1_pha_time, &stage_timing_record.encoder1_res_mag_time);
            encoder1_res_pha_time = elapsed_ms(&stage_timing_record.encoder1_res_mag_time, &stage_timing_record.encoder1_res_pha_time);

            encoder1_interaction_mag_time = elapsed_ms(&stage_timing_record.encoder1_res_pha_time, &stage_timing_record.encoder1_interaction_mag_time);
            ...
            encoder2_pha_time = elapsed_ms(&stage_timing_record.encoder2_mag_time, &stage_timing_record.encoder2_pha_time);

            encoder2_res_mag_time = elapsed_ms(&stage_timing_record.encoder2_pha_time, &stage_timing_record.encoder2_res_mag_time);
            encoder2_res_pha_time = elapsed_ms(&stage_timing_record.encoder2_res_mag_time, &stage_timing_record.encoder2_res_pha_time);

            encoder2_interaction_mag_time = elapsed_ms(&stage_timing_record.encoder2_res_pha_time, &stage_timing_record.encoder2_interaction_mag_time);
            ...
            latent_pha_time = elapsed_ms(&stage_timing_record.latent_mag_time, &stage_timing_record.latent_pha_time);

            latent_interaction_mag_time = elapsed_ms(&stage_timing_record.latent_pha_time, &stage_timing_record.latent_interaction_mag_time);
            latent_interaction_pha_time = elapsed_ms(&stage_timing_record.latent_interaction_mag_time, &stage_timing_record.latent_interaction_pha_time);
            ...
            decoder0_res_pha_time = elapsed_ms(&stage_timing_record.decoder0_res_mag_time, &stage_timing_record.decoder0_res_pha_time);

            decoder0_mag_time = elapsed_ms(&stage_timing_record.decoder0_res_pha_time, &stage_timing_record.decoder0_mag_time);
            decoder0_pha_time = elapsed_ms(&stage_timing_record.decoder0_mag_time, &stage_timing_record.decoder0_pha_time);

            decoder0_interaction_mag_time = elapsed_ms(&stage_timing_record.decoder0_pha_time, &stage_timing_record.decoder0_interaction_mag_time);
            ...
            decoder1_res_pha_time = elapsed_ms(&stage_timing_record.decoder1_res_mag_time, &stage_timing_record.decoder1_res_pha_time);

            decoder1_mag_time = elapsed_ms(&stage_timing_record.decoder1_res_pha_time, &stage_timing_record.decoder1_mag_time);
            decoder1_pha_time = elapsed_ms(&stage_timing_record.decoder1_mag_time, &stage_timing_record.decoder1_pha_time);

            decoder1_interaction_mag_time = elapsed_ms(&stage_timing_record.decoder1_pha_time, &stage_timing_record.decoder1_interaction_mag_time);
            ...
            decoder2_res_pha_time = elapsed_ms(&stage_timing_record.decoder2_res_mag_time, &stage_timing_record.decoder2_res_pha_time);

            decoder2_mag_time = elapsed_ms(&stage_timing_record.decoder2_res_pha_time, &stage_timing_record.decoder2_mag_time);
            decoder2_pha_time = elapsed_ms(&stage_timing_record.decoder2_mag_time, &stage_timing_record.decoder2_pha_time);

            decoder2_interaction_mag_time = elapsed_ms(&stage_timing_record.decoder2_pha_time, &stage_timing_record.decoder2_interaction_mag_time);
            ...
            output0_res_pha_time = elapsed_ms(&stage_timing_record.output0_res_mag_time, &stage_timing_record.output0_res_pha_time);

            output0_mag_time = elapsed_ms(&stage_timing_record.output0_res_pha_time, &stage_timing_record.output0_mag_time);
            output0_pha_time = elapsed_ms(&stage_timing_record.output0_mag_time, &stage_timing_record.output0_pha_time);
            /* --------------------- */
            output1_mag_time = elapsed_ms(&stage_timing_record.output0_pha_time, &stage_timing_record.output1_mag_time);
            output1_pha_time = elapsed_ms(&stage_timing_record.output1_mag_time, &stage_timing_record.output1_pha_time);
            /* --------------------- */
            output3_mag_time = elapsed_ms(&stage_timing_record.output1_pha_time, &stage_timing_record.output3_mag_time);
            output3_pha_time = elapsed_ms(&stage_timing_record.output3_mag_time, &stage_timing_record.output3_pha_time);

            output3_res_mag_time = elapsed_ms(&stage_timing_record.output3_pha_time, &stage_timing_record.output3_res_mag_time);
            /* --------------------- */
            final_low_freq_mag_time = elapsed_ms(&stage_timing_record.output3_res_mag_time, &stage_timing_record.final_low_freq_mag_time);
            final_low_freq_pha_time = elapsed_ms(&stage_timing_record.final_low_freq_mag_time, &stage_timing_record.final_low_freq_pha_time);

            /* --------------------- */
            istft_time = elapsed_ms(&stage_timing_record.final_low_freq_pha_time, &stage_timing_record.istft_time);
            ...
            low_freq_pha_time = elapsed_ms(&detail_timing_record.low_frequency_mag_time, &detail_timing_record.low_frequency_pha_time);

            spectrogram_res_mag_time = elapsed_ms(&detail_timing_record.low_frequency_pha_time, &detail_timing_record.spectrogram_res_mag_time);
            /* --------------------- */
            patch_embed_mag_time = elapsed_ms(&detail_timing_record.spectrogram_res_mag_time, &detail_timing_record.patch_embed_mag_time);
            patch_embed_pha_time = elapsed_ms(&detail_timing_record.patch_embed_mag_time, &detail_timing_record.patch_embed_pha_time);

            patch_embed_res_mag_time = elapsed_ms(&detail_timing_record.patch_embed_pha_time, &detail_timing_record.patch_embed_res_mag_time);
            patch_embed_res_pha_time = elapsed_ms(&detail_timing_record.patch_embed_res_mag_time, &detail_timing_record.patch_embed_res_pha_time);

            patch_embed_interaction_mag_time = elapsed_ms(&detail_timing_record.patch_embed_res_pha_time, &detail_timing_record.patch_embed_interaction_mag_time);
            ...
            encoder0_pvss_pha_time = elapsed_ms(&detail_timing_record.encoder0_mag_time, &detail_timing_record.encoder0_pvss_pha_time);
            encoder0_mlp_pha_time = elapsed_ms(&detail_timing_record.encoder0_pvss_pha_time, &detail_timing_record.encoder0_mlp_pha_time);
                /* --- */
            encoder0_pha_time = elapsed_ms(&detail_timing_record.encoder0_mag_time, &detail_timing_record.encoder0_pha_time);

            encoder0_res_mag_time = elapsed_ms(&detail_timing_record.encoder0_pha_time, &detail_timing_record.encoder0_res_mag_time);
            encoder0_res_pha_time = elapsed_ms(&detail_timing_record.encoder0_res_mag_time, &detail_timing_record.encoder0_res_pha_time);

            encoder0_interaction_mag_time = elapsed_ms(&detail_timing_record.encoder0_res_pha_time, &detail_timing_record.encoder0_interaction_mag_time);
            ...
            encoder1_pvss_pha_time = elapsed_ms(&detail_timing_record.encoder1_mag_time, &detail_timing_record.encoder1_pvss_pha_time);
            encoder1_mlp_pha_time = elapsed_ms(&detail_timing_record.encoder1_pvss_pha_time, &detail_timing_record.encoder1_mlp_pha_time);
                /* --- */
            encoder1_pha_time = elapsed_ms(&detail_timing_record.encoder1_mag_time, &detail_timing_record.encoder1_pha_time);

            encoder1_res_mag_time = elapsed_ms(&detail_timing_record.encoder1_pha_time, &detail_timing_record.encoder1_res_mag_time);
            encoder1_res_pha_time = elapsed_ms(&detail_timing_record.encoder1_res_mag_time, &detail_timing_record.encoder1_res_pha_time);

            encoder1_interaction_mag_time = elapsed_ms(&detail_timing_record.encoder1_res_pha_time, &detail_timing_record.encoder1_interaction_mag_time);
            ...
            encoder2_pvss_pha_time = elapsed_ms(&detail_timing_record.encoder2_mag_time, &detail_timing_record.encoder2_pvss_pha_time);
            encoder2_mlp_pha_time = elapsed_ms(&detail_timing_record.encoder2_pvss_pha_time, &detail_timing_record.encoder2_mlp_pha_time);
                /* --- */
            encoder2_pha_time = elapsed_ms(&detail_timing_record.encoder2_mag_time, &detail_timing_record.encoder2_pha_time);

            encoder2_res_mag_time = elapsed_ms(&detail_timing_record.encoder2_pha_time, &detail_timing_record.encoder2_res_mag_time);
            encoder2_res_pha_time = elapsed_ms(&detail_timing_record.encoder2_res_mag_time, &detail_timing_record.encoder2_res_pha_time);

            encoder2_interaction_mag_time = elapsed_ms(&detail_timing_record.encoder2_res_pha_time, &detail_timing_record.encoder2_interaction_mag_time);
            ...
            latent_pvss_pha_time = elapsed_ms(&detail_timing_record.latent_mag_time, &detail_timing_record.latent_pvss_pha_time);
            latent_mlp_pha_time = elapsed_ms(&detail_timing_record.latent_pvss_pha_time, &detail_timing_record.latent_mlp_pha_time);
                /* --- */
            latent_pha_time = elapsed_ms(&detail_timing_record.latent_mag_time, &detail_timing_record.latent_pha_time);

            latent_interaction_mag_time = elapsed_ms(&detail_timing_record.latent_pha_time, &detail_timing_record.latent_interaction_mag_time);
            latent_interaction_pha_time = elapsed_ms(&detail_timing_record.latent_interaction_mag_time, &detail_timing_record.latent_interaction_pha_time);
            ...
            decoder0_res_pha_time = elapsed_ms(&detail_timing_record.decoder0_res_mag_time, &detail_timing_record.decoder0_res_pha_time);

            decoder0_pvss_mag_time = elapsed_ms(&detail_timing_record.decoder0_res_pha_time, &detail_timing_record.decoder0_pvss_mag_time);
            decoder0_mlp_mag_time = elapsed_ms(&detail_timing_record.decoder0_pvss_mag_time, &detail_timing_record.decoder0_mlp_mag_time);
                /* --- */
            decoder0_mag_time = elapsed_ms(&detail_timing_record.decoder0_res_pha_time, &detail_timing_record.decoder0_mag_time);

            decoder0_pvss_pha_time = elapsed_ms(&detail_timing_record.decoder0_mag_time, &detail_timing_record.decoder0_pvss_pha_time);
            decoder0_mlp_pha_time = elapsed_ms(&detail_timing_record.decoder0_pvss_pha_time, &detail_timing_record.decoder0_mlp_pha_time);
                /* --- */
            decoder0_pha_time = elapsed_ms(&detail_timing_record.decoder0_mag_time, &detail_timing_record.decoder0_pha_time);

            decoder0_interaction_mag_time = elapsed_ms(&detail_timing_record.decoder0_pha_time, &detail_timing_record.decoder0_interaction_mag_time);
            ...
            decoder1_res_pha_time = elapsed_ms(&detail_timing_record.decoder1_res_mag_time, &detail_timing_record.decoder1_res_pha_time);

            decoder1_pvss_mag_time = elapsed_ms(&detail_timing_record.decoder1_res_pha_time, &detail_timing_record.decoder1_pvss_mag_time);
            decoder1_mlp_mag_time = elapsed_ms(&detail_timing_record.decoder1_pvss_mag_time, &detail_timing_record.decoder1_mlp_mag_time);
                /* --- */
            decoder1_mag_time = elapsed_ms(&detail_timing_record.decoder1_res_pha_time, &detail_timing_record.decoder1_mag_time);

            decoder1_pvss_pha_time = elapsed_ms(&detail_timing_record.decoder1_mag_time, &detail_timing_record.decoder1_pvss_pha_time);
            decoder1_mlp_pha_time = elapsed_ms(&detail_timing_record.decoder1_pvss_pha_time, &detail_timing_record.decoder1_mlp_pha_time);
                /* --- */
            decoder1_pha_time = elapsed_ms(&detail_timing_record.decoder1_mag_time, &detail_timing_record.decoder1_pha_time);

            decoder1_interaction_mag_time = elapsed_ms(&detail_timing_record.decoder1_pha_time, &detail_timing_record.decoder1_interaction_mag_time);
            ...
            decoder2_res_pha_time = elapsed_ms(&detail_timing_record.decoder2_res_mag_time, &detail_timing_record.decoder2_res_pha_time);

            decoder2_pvss_mag_time = elapsed_ms(&detail_timing_record.decoder2_res_pha_time, &detail_timing_record.decoder2_pvss_mag_time);
            decoder2_mlp_mag_time = elapsed_ms(&detail_timing_record.decoder2_pvss_mag_time, &detail_timing_record.decoder2_mlp_mag_time);
                /* --- */
            decoder2_mag_time = elapsed_ms(&detail_timing_record.decoder2_res_pha_time, &detail_timing_record.decoder2_mag_time);

            decoder2_pvss_pha_time = elapsed_ms(&detail_timing_record.decoder2_mag_time, &detail_timing_record.decoder2_pvss_pha_time);
            decoder2_mlp_pha_time = elapsed_ms(&detail_timing_record.decoder2_pvss_pha_time, &detail_timing_record.decoder2_mlp_pha_time);
                /* --- */
            decoder2_pha_time = elapsed_ms(&detail_timing_record.decoder2_mag_time, &detail_timing_record.decoder2_pha_time);

            decoder2_interaction_mag_time = elapsed_ms(&detail_timing_record.decoder2_pha_time, &detail_timing_record.decoder2_interaction_mag_time);
            ...
            output0_res_pha_time = elapsed_ms(&detail_timing_record.output0_res_mag_time, &detail_timing_record.output0_res_pha_time);

            output0_pvss_mag_time = elapsed_ms(&detail_timing_record.output0_res_pha_time, &detail_timing_record.output0_pvss_mag_time);
            output0_mlp_mag_time = elapsed_ms(&detail_timing_record.output0_pvss_mag_time, &detail_timing_record.output0_mlp_mag_time);
                /* --- */
            output0_mag_time = elapsed_ms(&detail_timing_record.output0_res_pha_time, &detail_timing_record.output0_mag_time);

            output0_pvss_pha_time = elapsed_ms(&detail_timing_record.output0_mag_time, &detail_timing_record.output0_pvss_pha_time);
            output0_mlp_pha_time = elapsed_ms(&detail_timing_record.output0_pvss_pha_time, &detail_timing_record.output0_mlp_pha_time);
                /* --- */
            output0_pha_time = elapsed_ms(&detail_timing_record.output0_mag_time, &detail_timing_record.output0_pha_time);
            
            /* --------------------- */
            output1_pvss_mag_time = elapsed_ms(&detail_timing_record.output0_pha_time, &detail_timing_record.output1_pvss_mag_time);
            output1_mlp_mag_time = elapsed_ms(&detail_timing_record.output1_pvss_mag_time, &detail_timing_record.output1_mlp_mag_time);
                /* --- */
            output1_mag_time = elapsed_ms(&detail_timing_record.output0_pha_time, &detail_timing_record.output1_mag_time);

            output1_pvss_pha_time = elapsed_ms(&detail_timing_record.output1_mag_time, &detail_timing_record.output1_pvss_pha_time);
            output1_mlp_pha_time = elapsed_ms(&detail_timing_record.output1_pvss_pha_time, &detail_timing_record.output1_mlp_pha_time);
                /* --- */
            output1_pha_time = elapsed_ms(&detail_timing_record.output1_mag_time, &detail_timing_record.output1_pha_time);
            
            /* --------------------- */
            output3_pvss_mag_time = elapsed_ms(&detail_timing_record.output1_pha_time, &detail_timing_record.output3_pvss_mag_time);
            output3_mlp_mag_time = elapsed_ms(&detail_timing_record.output3_pvss_mag_time, &detail_timing_record.output3_mlp_mag_time);
                /* --- */
            output3_mag_time = elapsed_ms(&detail_timing_record.output1_pha_time, &detail_timing_record.output3_mag_time);

            output3_pvss_pha_time = elapsed_ms(&detail_timing_record.output3_mag_time, &detail_timing_record.output3_pvss_pha_time);
            output3_mlp_pha_time = elapsed_ms(&detail_timing_record.output3_pvss_pha_time, &detail_timing_record.output3_mlp_pha_time);
                /* --- */
            output3_pha_time = elapsed_ms(&detail_timing_record.output3_mag_time, &detail_timing_record.output3_pha_time);

            output3_res_mag_time = elapsed_ms(&detail_timing_record.output3_pha_time, &detail_timing_record.output3_res_mag_time);
            ...
            final_low_freq_pha_time = elapsed_ms(&detail_timing_record.final_low_freq_mag_time, &detail_timing_record.final_low_freq_pha_time);

            /* --------------------- */
            istft_time = elapsed_ms(&detail_timing_record.final_low_freq_pha_time, &detail_timing_record.istft_time);
...
#ifdef _WIN32
    mkdir_status = mkdir(GENERATED_AUDIO_PATH);
#else
    mkdir_status = mkdir(GENERATED_AUDIO_PATH, 0777);
#endif
...
#ifdef _WIN32
    mkdir_status = mkdir(RESULT_PATH);
#else
    mkdir_status = mkdir(RESULT_PATH, 0777);
#endif
