...
#define GENERATED_AUDIO_PATH            "./data/test_audio/generated/naives/"

#define RESULT_PATH                     "./results/naives"
#define PROCESSING_TIMING_CSV_PATH      "./results/naives/processing_time.csv"
#define PROCESSING_TIMING_TXT_PATH      "./results/naives/processing_time.txt"
#define STAGE_TIMING_CSV_PATH           "./results/naives/stage_timing.csv"
#define DETAIL_STAGE_TIMING_CSV_PATH    "./results/naives/detail_stage_timing.csv"
